...
public class MainActivity extends AppCompatActivity {
    ...
    public void initSpeex(View view){
        audioUtils.initSpeex();
    }

    public void startRecordE(View view){
        audioUtils.startRecord();
    }

    public void stopRecordE(View view){
        audioUtils.stopRecord();
    }

    public void startPlayE(View view){
        audioUtils.startPlay();
    }

    public void stopPlayE(View view){
        audioUtils.stopPlay();
    }

    public void releaseE(View view){
        audioUtils.release();
    }
}
