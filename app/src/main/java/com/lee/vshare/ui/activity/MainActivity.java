...
import com.lee.vshare.ui.fragment.RecreationalFragment;
            ...
            switch (item.getItemId()) {
                ...
                case R.id.navigation_blogs:
                    if (TAB_INDEX_BLOGS != tabIndex) {
                        BlogFragment blogFragment = (BlogFragment) fragmentManager.findFragmentByTag(BlogFragment.TAG);
                        if (null == blogFragment) {
                            blogFragment = BlogFragment.newInstance();
                            addFragment(blogFragment, TAB_INDEX_BLOGS, BlogFragment.TAG);
                        } else {
