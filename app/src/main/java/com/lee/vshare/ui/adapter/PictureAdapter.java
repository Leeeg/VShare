...
import com.lee.vshare.databinding.ItemPictureBinding;

public class PictureAdapter extends RecyclerView.Adapter<PictureAdapter.PictureViewHolder> {

    private Context mContext;
    List<? extends com.lee.vshare.model.ex.Picture> mPictureList;

    @Nullable
    private final com.lee.vshare.listener.ItemClickListener pictureItemClickListener;
    ...
    public PictureAdapter(Context context, @Nullable com.lee.vshare.listener.ItemClickListener itemClickListener) {
        Log.d("Lee_PictureAdapter", "PictureAdapter");
        pictureItemClickListener = itemClickListener;
        setHasStableIds(true);
    }

    public void setPictureList(final List<? extends com.lee.vshare.model.ex.Picture> PictureList) {
        ...
        if (mPictureList == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    com.lee.vshare.model.ex.Picture newProduct = PictureList.get(newItemPosition);
                    com.lee.vshare.model.ex.Picture oldProduct = mPictureList.get(oldItemPosition);
