...
import com.lee.vshare.databinding.ItemLoginHistoryBinding;

public class LoginHistoryAdapter extends RecyclerView.Adapter<LoginHistoryAdapter.LoginHistoryViewHolder> {

    List<? extends com.lee.vshare.model.db.entity.ex.LoginHistory> mLoginHistories;

    @Nullable
    private final com.lee.vshare.listener.ItemClickListener historyItemClickListener;

    public LoginHistoryAdapter(@Nullable com.lee.vshare.listener.ItemClickListener itemClickListener) {
        historyItemClickListener = itemClickListener;
        setHasStableIds(true);
    }

    public void setLoginHistoryList(final List<? extends com.lee.vshare.model.db.entity.ex.LoginHistory> loginHistories) {
        if (mLoginHistories == null) {
            ...
            DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {
                    com.lee.vshare.model.db.entity.ex.LoginHistory newProduct = loginHistories.get(newItemPosition);
                    com.lee.vshare.model.db.entity.ex.LoginHistory oldProduct = mLoginHistories.get(oldItemPosition);
