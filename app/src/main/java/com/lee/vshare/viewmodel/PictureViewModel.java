...
public class PictureViewModel extends AndroidViewModel {
    ...
    private final MediatorLiveData<List<com.lee.vshare.model.ex.Picture>> mObservablePicture;
    ...
    public PictureViewModel(@NonNull Application application) {
        ...
        List<com.lee.vshare.model.ex.Picture> list = new ArrayList<>();
        for (int i = 0; i < 20; i++) {
            com.lee.vshare.model.PictureModel recreation = new com.lee.vshare.model.PictureModel();
        ...
        MediatorLiveData<List<com.lee.vshare.model.ex.Picture>> recreationList = new MediatorLiveData<>();
        recreationList.setValue(list);

        mObservablePicture.addSource(recreationList, mObservablePicture::setValue);
    }

    public MediatorLiveData<List<com.lee.vshare.model.ex.Picture>> getPicture() {
